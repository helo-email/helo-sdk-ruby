  ...
  class BroadcastStatistics
    ...
    def initialize(attributes = {})
      if !attributes.is_a?(Hash)
        fail ArgumentError, "The input argument (attributes) must be a hash in `Helo::BroadcastStatistics` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if !acceptable_attribute_map.key?(k.to_sym)
          fail ArgumentError, "`#{k}` is not a valid attribute in `Helo::BroadcastStatistics`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] sent Object to be assigned
    def sent=(sent)
      @sent = sent&.to_i
    end

    # Attribute writer method
    # @param [Object] delivered Object to be assigned
    def delivered=(delivered)
      @delivered = delivered&.to_i
    end

    # Attribute writer method
    # @param [Object] bounced Object to be assigned
    def bounced=(bounced)
      @bounced = bounced&.to_i
    end

    # Attribute writer method
    # @param [Object] opened Object to be assigned
    def opened=(opened)
      @opened = opened&.to_i
    end

    # Attribute writer method
    # @param [Object] clicked Object to be assigned
    def clicked=(clicked)
      @clicked = clicked&.to_i
    end

    # Attribute writer method
    # @param [Object] complained Object to be assigned
    def complained=(complained)
      @complained = complained&.to_i
    end

    # Attribute writer method
    # @param [Object] unsubscribed Object to be assigned
    def unsubscribed=(unsubscribed)
      @unsubscribed = unsubscribed&.to_i
    end
    ...
    def hash
      [ sent, delivered, bounced, opened, clicked, complained, unsubscribed ].hash
    end
